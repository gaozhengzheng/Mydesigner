...
public class Word {
	...
	public static boolean isKey(String word) {    //判断是否为关键字
		return key.contains(word);
	}

	public static boolean isOperator(String word) {  //判断是否为运算符
		return operator.contains(word);
	}

	public static boolean isBoundarySign(String word) {   //判断是不是界符
